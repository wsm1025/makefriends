...
app.use(expressJwt({
	...
	path: ['/api/users/login', '/api/basic/iconfont', '/api', '/api/users','/api/users/register','/api/users/checkEmail','/api/users/updatePasswordFromCode','/api/users/publishDeatail','/api/users/publishOneDeatail'] //除了这些地址，其他的URL都需要验证
}));
